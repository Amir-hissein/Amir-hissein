...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Amir%20Hissein%Abakar&fontSize=45&fontAlign=50&fontAlignY=40&desc=Software%20Developer%20%7C%20AI%20%26amp%3B%20ML%20Engineering&descAlign=50&descAlignY=58&fontSize=45&animation=fadeIn)
...
I enjoy working in **dynamic, challenging environments** and focus on **innovation, performance and code quality** in every project. I aim to build **reliable, scalable and well-architected** AI systems, using clean architecture and best practices from research to production.
